...
def gpu_maximum(data, Nx=10, Ny=10):
    """Function to convolve an imgage with a maximum filter on GPU."""
    # create numpy arrays
    ...
    prog = OCLProgram("./OpenCL/gpu_kernels/gpu_maximum.cl")
    
    # start kernel on gput
    prog.run_kernel("maximum",   # the name of the kernel in the cl file
